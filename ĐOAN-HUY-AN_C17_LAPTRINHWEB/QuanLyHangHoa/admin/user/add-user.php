		  ...
		  || empty($ngsinh) || empty($role)){
			...
			$rows         = mysqli_num_rows($result);
			  if($rows > 0){
				...
				$sqli = "INSERT INTO user (username, password, fullname, gender, address, phone, roleid, dateofbirth, status)
				values ('$user', '$pass', '$fullnameh', '$pay', '$diachi', '$sdt', '$role', '$ngsinh', '1')";
				$db->add($sqli);
							...
							<div class="dflex">
								<div class="form__file">
									...
									<input type="text" id="txtFullname" name="fullname"
										placeholder="Full Name" required="required" value="">
								</div>
								<div class="form__file">
							...
							<div class="dflex">
								<div class="form__file">
									...
									<input type="date" id="txtDate" name="date"
										placeholder="Date of birdth" value="">
								</div>
								<div class="form__file">
